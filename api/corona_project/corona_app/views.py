...
class CoronaAppResult(APIView):
	...
	def intersection_calculator(self, data_frame):
		...
		res_intersect.drop(['geometry'], axis=1)
		return res_intersect

# class MedicalMapList(APIView):
#     renderer_classes = [TemplateHTMLRenderer]
#     template_name = 'corona_app/profile_list.html'

#     def get(self, request):
#         queryset = MedicalMap.objects.all()
#         return Response({'profiles': queryset})


# class MedicalMapDetail(APIView):
# 	# med = MedicalMap.create(pk = pk)
# 	renderer_classes = [TemplateHTMLRenderer]
# 	template_name = 'corona_app/profile_detail.html'


# 	def get(self, request, pk):
# 		profile = get_object_or_404(MedicalMap, pk=pk)
